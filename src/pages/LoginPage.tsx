...
export default function LoginPage() {
  ...
  const handleUserLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // استخدام دالة setAuth الجديدة لتعيين كل شيء معاً
      if (profile && role) {
      ...
      const adminRoles = ['super_admin', 'Super Admin', 'admin', 'Admin', 'finance', 'Finance', 'operations', 'Operations', 'carrier_manager', 'Carrier Manager', 'vendor_manager', 'Vendor Manager', 'support', 'Buyer Support', 'analytics', 'Analytics'];
              ...
              <TabsContent value="user">
                <form onSubmit={handleUserLogin} className="space-y-6">
                  ...
                  <div className="pt-4 flex flex-col gap-4 text-center">
                    <Link to="/forgot-password" className="text-sm text-primary font-bold hover:underline">{t('forgot_password')}</Link>
