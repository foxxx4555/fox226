...
export default function AdminAnalytics() {
    ...
    const { data: stats, isLoading } = useQuery({
        ...
        queryFn: async () => {
            ...
            const totalLoads = totalLoadsRes.count;
            const activeLoads = activeLoadsRes.count;
            const completedLoads = completedLoadsRes.count;
            const totalDrivers = totalDriversRes.count;
        ...
        <AdminLayout>
            <div className="space-y-10" dir="rtl">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 relative">
                    <div>
                        <h1 className="text-4xl font-black text-slate-900 tracking-tighter">ذكاء الأسطول <span className="text-blue-600">Analytics</span></h1>
